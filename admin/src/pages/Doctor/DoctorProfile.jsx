        ...
        <div className="flex flex-col gap-4 m-5">
          <div>
            <img
              ...
              alt={`${profileData.name || 'Doctor'}'s profile`}
            />
          </div>
          ...
          <div className="flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white">
            ...
            <p className="text-gray-600 font-medium mt-4">
              Appointment fee: <span className="text-gray-600">{currency} { isEdit? <input type="number" onChange={(e)=>setProfileData(prev=>({...prev, fees: e.target.value}))} value={profileData.fee} /> :profileData.fees}</span>
            </p>
            ...
            <div className="flex gap-1 pt-2">
              <input onChange={()=>isEdit && setProfileData(prev=>({...prev, available: !prev.available}))} checked={profileData.available} type="checkbox" id="available-checkbox" />
