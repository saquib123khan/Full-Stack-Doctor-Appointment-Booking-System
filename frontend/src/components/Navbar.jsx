...
const Navbar = () => {
    ...
    const logout = () => {
        ...
        navigate('/login');  // Redirects user to login after logging out
    };
        ...
        <div className="flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400">
            ...
            <div className="flex items-center gap-4">
                ...
                token && userData ? (
                    ...
                    <button onClick={() => navigate('/login')} className="bg-primary text-white px-8 py-3 rounded-full font-normal hidden sm:block">
                        Create account
                    </button>
                )}
